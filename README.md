...
This table lists the configuration variables required to operate ThreatDown Nebula. These variables are specified when configuring a Malwarebytes Endpoint Protection asset in Splunk SOAR.
